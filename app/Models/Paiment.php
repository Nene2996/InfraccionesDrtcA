...
class Paiment extends Model
{
    ...
    protected $fillable = ['date_payment', 'proof_number', 'discount', 'total_amount', 'pending_amount', 'amount_paid', 'url_path_image_vaucher', 'paimentable_id', 'paimentable_type', 'type_proof_id', 'user_id'];
