<div class="@if (!$isOpenModalPaimentInspectionAct) hidden @endif flex items-center justify-center fixed left-0 bottom-0 w-full h-full bg-gray-600 bg-opacity-75">
        ...
        <form wire:submit.prevent="savePaiment" class="">
            <div class="flex flex-col p-4">
                <div class="flex items-center w-full border-b pb-4">
                    ...
                    <svg wire:click="CloseOpenModalPaimentInspectionAct"
                ...
                <fieldset class="border-2 border-gray-400 rounded-md p-2 mt-3 mb-3">
                             ...
                             <select name="" id="" class="rounded-md" wire:model="type_proof_id">
                                <option value="" disabled>Selecciona</option>
                                  @foreach ($type_proofs as $type_proof)
                                        <option class="text-xs" value="{{ $type_proof->id }}">{{ $type_proof->type }}</option>
                                  @endforeach
                             </select>
                        </div>
                        <div class="grid grid-cols-1">
                    ...
                    <div class="flex justify-center text-sm underline">
                        <h3><strong>DETALLES DE LOS DESCUENTOS A APLICAR:</strong></h3>
                    </div>
                    ...
                    <div class="border-t-2 mt-5 mb-5">
                        ...
                        <div class="flex justify-end font-bold pt-3 text-sm uppercase mr-5 ">
                            <span>@if ($inspection->hasPaiment($inspection->id)) Pendiente por pagar : S/ @else Total a pagar : S/  @endif </span>
                ...
                <div class="ml-auto">
                    ...
                    <button class="bg-gray-500 text-white font-bold py-2 px-4 rounded"
                            wire:click="CloseOpenModalPaimentInspectionAct"
                            type="button"
