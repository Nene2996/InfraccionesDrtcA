<div class="@if (!$isOpenModalPaimentFile) hidden @endif flex items-baseline pt-24 justify-center fixed left-0 bottom-0 w-full h-full bg-gray-600 bg-opacity-75">
