            ...
            <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                <div>
                    <p class="text-sm text-gray-700 leading-5">
                        ...
                        <span class="font-medium font-extrabold text-black">{{ $paginator->firstItem() }}</span>
                        <span>{!! __('a') !!}</span>
                        <span class="font-medium font-extrabold text-black">{{ $paginator->lastItem() }}</span>
                        <span>{!! __('de') !!}</span>
                        <span class="font-medium font-extrabold text-black">{{ $paginator->total() }}</span>
                                    ...
                                    <span wire:key="paginator-page{{ $page }}">
                                        @if ($page == $paginator->currentPage())
                                            <span aria-current="page">
                                                <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium  bg-white border border-gray-300 cursor-default leading-5 font-extrabold text-black bg-gray-200">{{ $page }}</span>
                                            </span>
                                        @else
